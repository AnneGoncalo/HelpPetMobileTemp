...
import helppet.com.br.helppetmobile.adapter.ExperienciaAdapter;
...
public class ExperienciaActivity extends AppCompatActivity {
    ...
    private ListView listViewExperiencia;
    private ExperienciaAdapter experienciaAdapter;

    public class ConsultaExperiencias extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String resposta) {
            ...
            Gson gson = new Gson();
            TypeToken<List<Experiencia>> tipoDado = new TypeToken<List<Experiencia>>() {
            };

            final ArrayList<Experiencia> experiencias = gson.fromJson(resposta, tipoDado.getType());

            if(experiencias.size() > 0 ){
                experienciaAdapter = new ExperienciaAdapter(context,experiencias);
                listViewExperiencia.setAdapter(experienciaAdapter);
                listViewExperiencia.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
